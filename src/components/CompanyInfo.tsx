        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="">
            ...
            <p className="text-lg text-slate-300 leading-relaxed mb-8">
              With over 3+ years of experience in international trade, we specialize in agricultural commodities. Our commitment to excellence has made us a trusted partner across more than 8+ countries.
            </p>
